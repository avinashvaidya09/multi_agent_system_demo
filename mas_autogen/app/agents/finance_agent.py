    ...
    def create_ai_agents(self):
        ...
        finance_agent = autogen.AssistantAgent(
            ...
            system_message=(
                ...
                4. For invoices and disputed items, you will follow similar approach as mentioned 
                   in point 2 but use fetch_invoices and fetch_disputed_items functions respctively.
